...
public class BoardCalculatorTest {
    ...
    @Test
    public void calculate_rook_rook_knight_3_boardSize() throws Exception {
        BoardCalculator boardCalculator = new BoardCalculator();
        assertEquals(6, boardCalculator.calculateCombinations(4, Arrays.asList("rook", "rook", "knight", "knight")));
    }
    ...
    @Test
    public void calculateCombinations() throws Exception {
        BoardCalculator boardCalculator = new BoardCalculator();
        assertEquals(20, boardCalculator.calculateCombinations(4, Arrays.asList("rook", "bishop", "knight")));
    }
}
